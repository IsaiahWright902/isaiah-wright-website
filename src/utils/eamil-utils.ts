export function GetReplyHTML(name: string) {
  const replyMessage = ` <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                                                            ...
                                                            <td role="modules-container" style="padding: 0px 0px 0px 0px; color: #000000; text-align: left;" bgcolor="#ffffff" width="100%" align="left">
                                                                ...
                                                                >
                                                                    <tbody>
                                                                        <tr>
                                                                            <td
                                                                                style="padding: 0px 0px 0px 0px; line-height: 22px; text-align: inherit; background-color: #ffffff;"
                                                                                height="100%"
                                                                                valign="top"
                                                                                bgcolor="#FFFFFF"
                                                                                role="module-content"
                                                                            ...
                                                                            <td style="padding: 18px 20px 18px 30px; line-height: 22px; text-align: inherit;" height="100%" valign="top" bgcolor="" role="module-content">
                                                                                <div>
                                                                                    <div style="font-family: inherit; text-align: inherit;">
                                                                                        Dear ${name},<br />
                                                                                        Thank you for reaching out! I've received your email and wanted to let you know that I appreciate your interest. I'll be sure to review your submission
                                                                                        carefully and will get back to you as soon as possible. Your patience is greatly appreciated.<br />
                                                                                        <br />
                                                                                        Best regards,<br />
                                                                                        Isaiah
                                                                                    </div>
